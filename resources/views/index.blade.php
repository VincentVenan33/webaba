                                ...
                                <div class="card-body">
                                    <div class="row mt-1 align-items-center">
                                        <div class="col-12 col-lg-2 text-left pl-4">
                                            <span class="h3">{{ $totalOnline }}</span>
                                            <p class="text-muted mt-2"> Online Visitor </p>
                                        </div>
                                        <div class="col-6 col-lg-2 text-center py-4">
                                            <span class="h3">{{ $totalMonthlyVisitors[0]->totalMonthlyVisitors }}</span><br />
                                        ...
                                        <div class="pb-3 timeline-item item-success">
                                            <div class="pl-5">
                                                ...
                                                <div class="card d-inline-flex mb-2">
                                                    <div class="card-body bg-light py-2 px-3 small rounded"> Lorem ipsum
