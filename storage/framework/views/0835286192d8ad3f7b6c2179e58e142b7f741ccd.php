        ...
        <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
            ...
            <nav class="vertnav navbar navbar-light">
                ...
                <div class="w-100 mb-4 d-flex">
                    <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="<?php echo e(route('index')); ?>">
                        <img class="logo" src="<?php echo e(url('')); ?>/assets/images/logo.png" alt="asiabangunabadi" />
                    </a>
                </div>
                <ul class="navbar-nav flex-fill w-100 mb-2">
                    <a href="<?php echo e(route('index')); ?>" class="nav-link"><i class="fe fe-home fe-16"></i> <span class="ml-3 item-text">Dashboard</span></a>
